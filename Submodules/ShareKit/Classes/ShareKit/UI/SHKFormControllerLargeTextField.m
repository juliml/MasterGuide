...
- (void)setupBarButtonItems {
    ...
    NSLog(@"CAMPO %@", [self.navigationItem.leftBarButtonItem title]);
    
    [self.navigationItem.leftBarButtonItem setTintColor:[UIColor colorWithRed:175/255.0f green:10/255.0f blue:35/255.0f alpha:1.0]];
    [self.navigationItem.rightBarButtonItem setTintColor:[UIColor colorWithRed:175/255.0f green:10/255.0f blue:35/255.0f alpha:1.0]];
}
